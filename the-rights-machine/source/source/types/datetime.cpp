...
bool types::datetime::from(string const &source)
{
	char yy[] = { '0', '0', 0, 0, 0 };
	char mm[] = { '0', '0', 0 };
	char dd[] = { '0', '0', 0 };
...
string types::datetime::padding(string source, long count)
{
...
types::datetime types::datetime::now()
{
...
void types::datetime::copy(datetime const &source)
{
	year = source.year;
	month = source.month;
	day = source.day;
